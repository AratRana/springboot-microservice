...
public class CustomerClient {
	...
	private String customerURL() {
		String url;
		if (useRibbon) {
			ServiceInstance instance = loadBalancer.choose("CUSTOMERSERVICE");
			url = String.format("http://%s:%s/customerservice/", instance.getHost(), instance.getPort());
		} else {
			url = String.format("http://%s:%s/customerservice/", customerServiceHost, customerServicePort);
		}
